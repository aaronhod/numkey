...
const SwitchThemeButton: React.FC = () => {
    ...
    return (
        <Button variant="ghost"  size="icon" onClick={() => toggleTheme()}>
            <Sun size={30} className="rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
            <Moon size={30} className="absolute rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
        </Button>
    );
};
